                 ...
                 <div><Button className="bg-blue-500 hover:bg-blue-700 text-blue-600 hover:text-red-600 font-bold py-2 px-4 rounded" onClick={this.handleClick}>Menu</Button></div>
                       <div>{this.state.isOpen? 
                            <div className="bg-cover bg-center shadow overflow-hidden h-100 w-40" style={{ backgroundColor: 'black', opacity: "0.7", position: 'absolute', left: "0rem", top: '5.5rem', height:'50rem', width: "20rem" }}>
                                <ul class="list-reset">
                                     <li >
                                        <a href="#" className="block p-10 text-xl text-grey-darker text-white font-bold border-purple hover:bg-grey-lighter border-r-4" style={{fontSize: "2.5rem",  fontFamily: "alegreya",color: "white", textDecoration: 
                                            "none"}}>Home</a>
                                     </li>
                                     <li >
                                        <a href="#" className="block p-10 text-xl text-grey-darker text-white font-bold border-grey-lighter hover:border-purple-light hover:bg-grey-lighter border-r-4" style={{fontSize: "2.5rem", fontFamily: "alegreya", color: "white", textDecoration: 
                                            "none"}}>Favourites</a>
                                     </li>
                                     <li >
                                     <a href="#" className="block p-10 text-xl text-grey-darker text-white font-bold border-grey-lighter hover:border-purple-light hover:bg-grey-lighter border-r-4" style={{fontSize: "2.5rem", fontFamily: "alegreya",color: "white", textDecoration: 
